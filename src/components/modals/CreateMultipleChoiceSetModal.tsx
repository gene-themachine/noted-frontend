...
import { X, BookOpen, CheckCircle, FileText, PlusCircle, Brain } from 'lucide-react'
import { LibraryItem } from '../../types/studySets'
import { NoteSummary } from '../../types'

interface CreateMultipleChoiceSetModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: (data: {
    name: string
...
export default function CreateMultipleChoiceSetModal({
  isOpen,
  onClose,
  onConfirm,
  projectNotes,
...
}: CreateMultipleChoiceSetModalProps) {
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold text-foreground">Create Multiple Choice Set</h3>
              </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-border-light rounded-xl bg-background focus:outline-none focus:ring-2 focus:ring-primary-orange focus:border-transparent text-foreground"
                autoFocus
              />
            </div>
                      ...
                      return (
                        <div
                          ...
                          className={`p-3 rounded-xl border border-border-light cursor-pointer transition-colors duration-200 ${
                            isSelected
                              ? 'bg-orange-50 border-primary-orange'
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                onClick={handleClose}
                className="px-4 py-2 text-foreground-secondary hover:text-foreground transition-colors duration-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-orange focus:ring-offset-2"
              >
                Cancel
              </button>
              <button
                ...
                className={`px-5 py-2 font-semibold rounded-xl transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  canSubmit
                    ? 'bg-primary-orange text-foreground-inverse hover:bg-hover-orange focus:ring-primary-orange'
